...
int main ()
{
  ...
  int NExp;			// number of experiments to evaluate the qCPU state
  int NqBits = 16;	// number of qBits

  TqCPU MyQuantumCPU;
  qCPU_alloc("qCluster", NqBits, &MyQuantumCPU);

  NExp = 1;
  Evaluate_qCPU_State(&MyQuantumCPU, NExp);
...
qCluster CPU word (1 experiments) : 		down down down down down down down down up down down down down down down down 
qCluster CPU word (100 experiments) : 		down down down down down down up up up up down down down down down down 
------------------------------------------------------------
